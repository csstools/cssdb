...
export function renderFooter() {
	return html`
		<footer>
			...
			<p>Logos (except for Internet Explorer, BlackBerry, Baidu, Oculus and QQ) are from <a href="https://github.com/alrra/browser-logos">alrra/browser-logos</a>. Check them out!</p>
